...
i64 Tundra_stdout_u64(u64 num)
{
    ...
    u64 converted_length = Tundra_u64_to_str_buf(num, buffer);
...
i64 Tundra_stdout_i64(i64 num)
{
    ...
    u64 converted_length = Tundra_i64_to_str_buf(num, buffer);
...
i64 Tundra_stdout_u32(u32 num)
{
    ...
    u64 converted_length = Tundra_u32_to_str_buf(num, buffer);
...
i64 Tundra_stdout_int(int num)
{
    ...
    u64 converted_length = Tundra_int_to_str_buf(num, buffer);
...
i64 Tundra_stdout_u16(u16 num)
{
    ...
    u64 converted_length = Tundra_u16_to_str_buf(num, buffer);
...
i64 Tundra_stdout_i16(i16 num)
{
    ...
    u64 converted_length = Tundra_i16_to_str_buf(num, buffer);
...
i64 Tundra_stdout_u8(u8 num)
{
    ...
    u64 converted_length = Tundra_u8_to_str_buf(num, buffer);
...
i64 Tundra_stdout_i8(i8 num)
{
    ...
    u64 converted_length = Tundra_i8_to_str_buf(num, buffer);
